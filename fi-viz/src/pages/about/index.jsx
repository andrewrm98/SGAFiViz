  ...
  return (
    <div>
      <div class = "big-container notification center-text">
        <h1 class = 'title is-size-2 wpi-red'>The SGA Mission Statement</h1>
        <hr></hr>
      ...
      <div class = "columns">
        ...
        <div class = "column">
          <div class = "center-text notification has-background-light">
            ...
            <h1 class = "is-size-4">Join a club, or start your own!</h1>
            <h1 class = "is-size-4">Attend campus events</h1>
      ...
      <div class = "big-container notification center-text">
      <h1 class = 'title is-size-2 wpi-red'>Administrator Access</h1>
